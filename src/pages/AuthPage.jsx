...
const testimonials = [
  { 
    quote: "AlumNET connected me with a mentor who completely changed my career trajectory. The centralized platform made networking effortless.", 
    author: "Priya Sharma", 
    role: "Class of 2018",
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-2/5 p-6 lg:p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="text-xs lg:text-sm text-slate-500 relative">
          ...
          <p className="mt-4 lg:mt-6 text-center text-slate-400 text-xs">
            © {new Date().getFullYear()} AlumNET - SIH 2025 Solution
          </p>
        </div>
      </div>
          ...
          <div className="bg-white/90 backdrop-blur-lg border border-slate-200/50 rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl p-4 sm:p-6 lg:p-8 hover:shadow-3xl transition-all">
            ...
            <div className="text-center mb-4 sm:mb-6">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
                {isLogin ? "Welcome Back" : "Join AlumNET"}
              </h2>
