...
// This is only for local demo without backend.

export const ADMIN_CONFIG = {
  // Change these to update the demo credentials quickly
  email: "admin@college.edu",
  password: "Tiwariji",      // keep a strong demo password
  collegeId: "iit-delhi",     // optional: useful if you mock multi-tenancy later
